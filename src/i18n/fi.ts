...
export const fi = {
  ...
  timer: {
    enable: 'Ajastin',
    enableHint: 'Ajasta lepo (yksinkertainen) tai nousu + palautuminen (kaksi ajastinta).',
    modeSimple: 'Yksinkertainen',
    modeComplex: 'Kaksi ajastinta',
    rest: 'Lepo',
    climb: 'Nousu',
    recovery: 'Palautuminen',
    tapToStartClimb: 'Paina aloittaaksesi nousu',
    climbing: 'Nousu käynnissä — kirjaa lopettaaksesi',
    lastClimb: 'Viimeisin nousu',
  },
  plan: {
    ...
    changeBaseline: 'Vaihda pohjasessio',
    showOlder: 'Näytä vanhemmat',
  ...
  settings: {
    ...
    gradeColumns: 'Astenappien määrä rivillä',
    timerSection: 'Ajastin',
    climbTimeSubtract: 'Vähennä nousuajasta (s)',
    climbTimeSubtractHint: 'Kahden ajastimen tilassa: vähennetään jokaisesta mitatusta nousuajasta (esim. yksin kiivetessä nousu ei ala napin painalluksesta).',
    visibleGrades: 'Näytettävät asteet',
    visibleGradesHint: 'Piilota asteet joita et kiipeä — ne katoavat Treeni-näkymän astevalikosta.',
